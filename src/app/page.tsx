...
import { Search, Settings, LogOut, Users, List, Play, Menu, X, Film, Bookmark, Clock } from "lucide-react";
...
<div>
  ...
  <ul className="space-y-3 font-medium">
    <li className="flex items-center gap-2 text-red-500 hover:text-red-400 cursor-pointer transition-all">
      <Film size={16} />
      <span>Browse</span>
    </li>
    <li className="flex items-center gap-2 hover:text-gray-200 cursor-pointer transition-all">
      <Bookmark size={16} />
      <span>Watchlist</span>
    </li>
    <li className="flex items-center gap-2 hover:text-gray-200 cursor-pointer transition-all">
