        ...
        <nav className="space-y-8 text-sm overflow-y-auto max-h-[80vh]">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="hover:text-gray-800 dark:hover:text-gray-200 cursor-pointer flex items-center gap-2 transition-all">
          ...
          <div>
            <p className="uppercase text-gray-500 dark:text-gray-400 text-xs mb-3 tracking-wider">General</p>
            <ul className="space-y-3">
              <li className="hover:text-gray-800 dark:hover:text-gray-200 cursor-pointer flex items-center gap-2 transition-all">
        ...
        <div className="flex-1 lg:pr-8">
          ...
          <header className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-4">
            <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-start">
              ...
              <div className="flex items-center gap-2">
                <button className="p-2 bg-gray-200 dark:bg-gray-800 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-700 transition">&lt;</button>
                <button className="p-2 bg-gray-200 dark:bg-gray-800 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-700 transition">&gt;</button>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto">
              <div className="relative flex-1 sm:flex-initial">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-10 py-2 rounded-lg w-full sm:w-72 focus:ring-2 focus:ring-red-500 outline-none"
                />
              </div>
          ...
          <section className="relative rounded-2xl overflow-hidden shadow-2xl mb-12 group">
            ...
            <div className="absolute bottom-0 left-0 p-4 sm:p-8">
              ...
              <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 mb-4">Top Pick • 2 Seasons</p>
              <div className="flex items-center gap-3">
                ...
                <button className="bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 px-3 sm:px-4 py-2 rounded-lg text-sm font-semibold transition-all">+</button>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {["Breaking Bad Party", "Stranger Things Party", "Money Heist Watch"].map((title, i) => (
                <div
                  key={i}
                  className="bg-gray-200 dark:bg-gray-800 rounded-xl overflow-hidden hover:scale-105 transition-all cursor-pointer shadow-xl"
                >
                  <Image
                    src="/cabron.png"
                    alt={title}
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Join your friends to watch together</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
              {["The Witcher", "Haunting of Hill House", "Stranger Things", "El Camino", "Ratched"].map((title, i) => (
                <div
                  key={i}
                  className="bg-gray-200 dark:bg-gray-800 rounded-xl overflow-hidden hover:scale-105 transition-all shadow-xl cursor-pointer"
                >
                  <Image
                    src="/cabron.png"
                    alt={title}
                  ...
                  <div className="p-3">
                    ...
                    <div className="mt-2 h-1 bg-gray-400 dark:bg-gray-600 rounded-full">
          ...
          {["/icon.png", "/icon.png", "/icon.png", "/icon.png"].map((src, i) => (
            <div key={i} className="flex flex-col items-center cursor-pointer hover:opacity-80 transition">
              <Image
                ...
                className="rounded-full border border-gray-300 dark:border-gray-700"
              />
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">User {i + 1}</p>
            </div>
          ))}
        </aside>
